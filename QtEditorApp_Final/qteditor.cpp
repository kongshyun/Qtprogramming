    ...
    : QMainWindow(parent)
{
    ...
    QAction *quitAct = makeAction(":/images/quit.png", tr("&Quit"), QKeySequence("Ctrl+Q"), \
    ...
    QAction *colorAct = makeAction(":/images/color.png", tr("&Color"), QKeySequence("Ctrl+Shift+C"), tr("Set color"), this, SLOT(setColor( )));
    QAction *fontAct = makeAction(":/images/font.png", tr("&Font"), QKeySequence("Ctrl+Shift+F"), tr("Set font"), this, SLOT(setFont( )));

    QMenu *formatMenu = menubar->addMenu("&Format");
    formatMenu->addAction(colorAct);
    formatMenu->addAction(fontAct);

    QAction *leftAct = makeAction(":/images/left.png", tr("&Left"), QKeySequence("Ctrl+1"), tr("Align left"), this, SLOT(alignText()));
    QAction *centerAct = makeAction(":/images/center.png", tr("&Center"), QKeySequence("Ctrl+2"), tr("Align center"), this, SLOT(alignText()));
    QAction *rightAct = makeAction(":/images/right.png", tr("&Right"), QKeySequence("Ctrl+3"), tr("Align right"), this, SLOT(alignText()));
    QAction *justifyAct = makeAction(":/images/justify.png", tr("&Justify"), QKeySequence("Ctrl+4"), tr("Align justify"), this, SLOT(alignText()));
    ...
    QAction *tileAct = makeAction(":/images/tile.png", tr("&Tile"), QKeySequence("Ctrl+Shift+T"), \
                                  tr("tile"), mdiArea, SLOT(tileSubWindows( )));
    QAction *cascateAct = makeAction(":/images/cascade.png", tr("&Cascade"), QKeySequence("Ctrl+Shift+C"), \
    ...
    QAction *aboutAct = makeAction(":/images/about.png", tr("&About"), QKeySequence("Ctrl+Shift+A"), \
                                   tr("About"), this, SLOT(about( )));

    QAction *aboutQtAct = makeAction(":/images/aboutQt.png", tr("About &Qt"), QKeySequence("Ctrl+Shift+Q"), \
...
void QtEditor::saveasFile( )
{
    ...
    //QString fileName = QFileDialog::getSaveFileName(this,tr("Select file to save as"), QDir::homePath(), tr("Text Files (*.txt *.html *.htm *.c *.cpp *.h *.hpp *.cs)"));
    //qDebug() << fileName;
    QMdiSubWindow *subWindow = mdiArea->currentSubWindow( );
    if(subWindow != nullptr){
